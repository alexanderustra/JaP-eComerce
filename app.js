...
const validarToken = (req, res, next) => {
  try {
    ...
    res
      .status(500)
      .json({ message: "Error al validar el token: " + error.message });
  }
};
...
app.get("/productos/:id", (req, res) => {
  ...
  try {
    ...
    res
      .status(500)
      .json({ message: "Error al leer el archivo JSON: " + error.message });
  }
});
...
app.delete("/eliminar-del-carrito/:productId", (req, res) => {
  ...
  try {
    ...
    const indexToRemove = cartData.articles.findIndex(
